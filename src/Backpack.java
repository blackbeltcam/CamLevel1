...
Backpack jasper = new Backpack ();
 Pencil sup = new Pencil();
 Ruler wasup = new Ruler();
 Textbook nope = new Textbook();
jasper.putInBackpack(sup);
jasper.putInBackpack(wasup);
jasper.putInBackpack(nope);
 jasper.goToSchool();
 sup.write("I don't want to be here.");
 wasup.measure();
 nope.read();
