...
public class SimonSaysRecipe extends KeyAdapter {
	...
	private void makeAlbum() {
		...
		images.put(new Integer(KeyEvent.VK_UP), "Up arrow.jpeg");
		images.put(new Integer(KeyEvent.VK_RIGHT), "Right Arrow.jpeg");
		...
		speak("Press the matching key when 'Simeon says' otherwise press a different key");
	...
	private void showImage() {
		...
		bobosis.setVisible(true);
		// frame.add(getNextRandomImage()); //7. rename to the name of your frame
		bobosis.add(getNextRandomImage());
		// 8. set the size of the frame
		bobosis.setSize(400, 400);
